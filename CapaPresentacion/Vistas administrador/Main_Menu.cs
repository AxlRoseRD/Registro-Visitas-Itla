...
namespace CapaPresentacion
{
    public partial class Main_Menu : Form
    {
        ...
        public Main_Menu(E_usuario user)
        {
            InitializeComponent();
            usuario = user;
        ...
        private void btnAdministrarEdificios_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBcolors.azul_Verdoso_Boton_Itla); //agrega animacion al boton
            OpenChildForm(new Administrar_edificios()); //abre el nuevo formulario
        }

        private void btnAdministrarAulas_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBcolors.azul_Verdoso_Boton_Itla); //agrega animacion al boton
            OpenChildForm(new Administrar_Aulas()); //abre el nuevo formulario
        }
